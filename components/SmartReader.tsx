...
import { 
  ...
  ArrowLeftRight, Maximize, ArrowLeft
} from 'lucide-react';
...
// --- Main Component ---
export const SmartReader: React.FC<SmartReaderProps> = ({ file, onFrameCapture, onPageText, isLive, onBack }) => {
  // PDF State
    ...
    <div className="flex flex-col h-full bg-slate-100 relative">
      ...
      <div className="sticky top-0 z-20 px-3 py-2 md:px-4 md:py-3 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm flex items-center justify-between gap-4 overflow-x-auto no-scrollbar">
        ...
        <div className="flex items-center gap-3 shrink-0">
            ...
            <div className="flex items-center gap-2 bg-slate-100 rounded-lg px-3 py-1.5 text-slate-600 font-mono text-xs md:text-sm whitespace-nowrap">
